...
import { listCategories, resolveImageUrl } from "@/lib/api";
import type { Category } from "@/lib/types";

// A homepage showcase row, distinct from components/CategoryNav.tsx (the
// header's compact text-pill filter bar) — this is a landing element in its
// own right: category photography where set, sized to actually invite a
  ...
  return (
    <div className="mb-10 sm:mb-14">
      {/* sm:grid-cols-[repeat(auto-fit,minmax(...))] rather than a fixed
          ...
          categories got tiles stretched thin with a wide dead gap next to
