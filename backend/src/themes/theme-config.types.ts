...
export interface ButtonStyleSettings {
  ...
  // --theme-radius. Absent ⇒ today's radius. Mirrored in the two frontend
  // type files.
  pill?: boolean;
}
...
export interface CartSettings {
  ...
  // §8.13.C item 13 — optional. Storefront-only render hints; absent ⇒
  // today's instant cart-drawer render. Mirrored in the two frontend types.
...
export interface DrawerSettings {
  ...
  dropShadow: boolean;
  // §8.13.C item 13 — optional. Cart drawer open transition; absent /
...
export interface InputFieldSettings {
  ...
  // unbuilt. Absent/'none' ⇒ today's plain input. Mirrored in the frontends.
