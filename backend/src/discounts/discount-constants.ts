...
export const DISCOUNT_REJECTION_MESSAGES: Record<DiscountRejectionReason, string> = {
  ...
  min_purchase_not_met: 'Your order does not meet the minimum purchase amount for this code',
  usage_limit_reached: 'This code has reached its usage limit',
  per_customer_limit_reached: 'You have already used this code the maximum number of times',
