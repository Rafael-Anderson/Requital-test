...
// what this page does). Each field is a write-only SecretField — once
// saved, only the masked value is ever shown again, behind a Replace button.
    ...
    <div className="space-y-3">
      {PROVIDER_CREDENTIAL_FIELDS[provider].map((field) => (
        <SecretField
          key={field.key}
          label={field.label}
          masked={maskedCredentials?.[field.key] ?? null}
